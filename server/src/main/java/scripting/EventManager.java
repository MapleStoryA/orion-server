...
public class EventManager {
    ...
    public void startInstance(MapleCharacter character, String leader) {
        try {
            ...
            log.info(
                    "Log_Script_Except.rtf" + " : " + ("Event name : " + name + ", method Name : setup-Guild:\n" + ex));
        }
    }
    ...
    public void startInstance(MapleSquad squad, MapleMap map) {
        ...
        try {
            ...
            log.info(
                    "Log_Script_Except.rtf" + " : " + ("Event name : " + name + ", method Name : setup-squad:\n" + ex));
        }
    }
    ...
    public void set2xExpEvent(boolean enabled) {
        for (ChannelServer channel : WorldServer.getInstance().getAllChannels()) {
            if (enabled) {
                ...
                channel.setExpRate(channel.getExpRate());
            }
        }
    }
