...
public class MapleLifeFactory {
    ...
    private static final MapleDataProvider stringDataWZ = ServerEnvironment.getConfig().getDataProvider("wz/String");
    private static final MapleDataProvider etcDataWZ = ServerEnvironment.getConfig().getDataProvider("wz/Etc");
