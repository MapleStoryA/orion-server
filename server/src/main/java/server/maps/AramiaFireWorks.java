...
public class AramiaFireWorks {
    ...
    private static final int[] REWARDS = {
        2022176, 1092030, 2022175, 2000002, 2000002, 2002001, 2002002, 2002003, 2002004, 2002005,
        2050004, 1012098, 1012101, 1012102, 1012103
    };
    private static final int[] array_X = {
        720, 180, 630, 270, 360, 540, 450, 142, 142, 218, 772, 810, 848, 232, 308, 142
    };
    private static final int[] array_Y = {
        1234, 1234, 1174, 1234, 1174, 1174, 1174, 1260, 1234, 1234, 1234, 1234, 1234, 1114, 1114,
        1140
    };
