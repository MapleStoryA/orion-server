    ...
    public void handlePacket(CInPacket packet, final MapleClient c) {
        ...
        if (chr == null
                || (energy
                        ...
                        && !GameConstants.isKOC(chr.getJob().getId()))) {
            return;
        }
        ...
        if (!energy) {
            ...
            if (attack.targets > 0 && attack.skill == 1211002) { // handle
                ...
                if (advcharge_level > 0) {
                    if (!SkillFactory.getSkill(1220010)
                            .getEffect(advcharge_level)
                            .makeChanceResult()) {
            ...
            if (numFinisherOrbs > 0) {
                ...
                ISkill combo;
                if (c.getPlayer().getJob().getId() == 1110
                        || c.getPlayer().getJob().getId() == 1111) {
