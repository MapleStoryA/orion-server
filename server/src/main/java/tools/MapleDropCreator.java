    ...
    private static int getChance(int id, int mobid, boolean boss) {
        switch (id / 10000) {
            case 100: // Hat
                ...
                return 1500;
            case 103: // Earring
                if (id == 1032062) { // Element Pierce - Neo Tokyo
                    return 100; // 7 Slots earring with +2 to str/dex/int/luk/ma
                }
                return 1000;
            case 105: // Overall
            case 109: // Shield
                if (id == 1092049) { // Dragon Khanjar
                    return 100;
                }
                return 700;
            case 104: // Topwear
            case 106: // Pants
            case 107: // Shoes
                if (id == 1072369) { // Squachy shoe [King slime, Kerning PQ]
                    return 300000; // 30%
                }
                return 800;
            case 108: // Gloves
            ...
            case 137: // Wand
                if (id == 1372049) { // Zakum Tree Branch
                    return 999999;
                }
                return 700;
            case 138: // Staff
            ...
            case 233: // Bullets and capsules
                if (id == 2330007) { // Armor-Piercing bullet
                    return 50;
                }
                return 500;
            case 400:
