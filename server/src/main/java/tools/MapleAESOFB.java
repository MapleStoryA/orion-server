...
public class MapleAESOFB {
    ...
    public MapleAESOFB(byte[] iv, short mapleVersion) {
        try {
            ...
            System.err.println("Error initalizing the encryption cipher.  Make sure you're using the Unlimited"
    ...
    public byte[] getPacketHeader(int length) {
        ...
        return new byte[] {
            (byte) ((iiv >>> 8) & 0xFF), (byte) (iiv & 0xFF), (byte) ((mlength >>> 8) & 0xFF), (byte) (mlength & 0xFF)
        };
    }
