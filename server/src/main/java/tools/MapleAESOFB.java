...
public class MapleAESOFB {
    ...
    public MapleAESOFB(byte[] iv, short mapleVersion) {
        try {
            ...
            System.err.println(
                    "Error initalizing the encryption cipher.  Make sure you're using the Unlimited"
                            + " Strength cryptography jar files.");
        }
    ...
    public static int getPacketLength(int packetHeader) {
        ...
        packetLength =
                ((packetLength << 8) & 0xFF00) | ((packetLength >>> 8) & 0xFF); // fix endianness
        return packetLength;
    }
    ...
    /**
     * Does funny stuff. <code>this.OldIV</code> must not equal <code>in</code> Modifies <code>in
     ...
     * @return <code>True</code> if the packet has a correct header, <code>false</code> otherwise.
     */
     ...
     * @return <code>True</code> if the header is correct, <code>false</code> otherwise.
     */
    public boolean checkPacket(int packetHeader) {
        return checkPacket(
                new byte[] {
                    (byte) ((packetHeader >> 24) & 0xFF), (byte) ((packetHeader >> 16) & 0xFF)
                });
    }
