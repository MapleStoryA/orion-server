	...
	if (status == 0) {
		if (geenie == null) {
			...
			cm
				...
				&& geenie.getProperty("docked").equals("true")) {
		...
		if (!cm.haveItem(4031045)) {
			cm
					.sendNext("Oh no ... I don't think you have the ticket with you. I can't let you in without it. Please buy the ticket at the ticketing booth.");
		} else {
