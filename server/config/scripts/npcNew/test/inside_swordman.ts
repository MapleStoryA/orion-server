...
if (target.nJob() == 100 &&
    ...
    if (inventory.itemCount(4031013) >= 30) {
        ...
        let ret = inventory.exchange(0, 4031013, -nBlack, 4031008, -1, 4031012, 1);
        ...
        let nRet = self.askYesNo("O que est� acontecendo? Acho que voc� n�o juntou 30 itens do tipo #b#t4031013##k ainda... Se estiver tendo problemas com isso, voc� pode sair agora e tentar novamente mais tarde. Ent�o... quer desistir e dar o fora daqui?");
