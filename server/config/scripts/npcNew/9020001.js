...
function party1_personal() {
    ...
    desc = "";
    if (q == 0) {
        desc = "Assignment. The number of coupons you should collect is the same number of experience points required to advance from #rlevel 1 to level 2.";
        ans = 15;
    } else if (q == 1) {
        desc = "Esta é a tarefa. O número de cupons que você deve coletar é o mesmo número do nível necessário para fazer o primeiro avanço na carreira como feiticeiro.";
        ans = 8;
    } else if (q == 2) {
        desc = "Esta é a tarefa. O número de cupons que você deve coletar é o mesmo número do nível mínimo de FOR necessária para fazer o primeiro avanço na carreira como guerreiro.";
        ans = 35;
    } else if (q == 3) {
        desc = "Esta é a tarefa. O número de cupons que você deve coletar é o mesmo número do nível mínimo de INT necessária para fazer o primeiro avanço na carreira como bruxo.";
        ans = 20;
    } else if (q == 4) {
        desc = "Esta é a tarefa. O número de cupons que você deve coletar é o mesmo número do nível mínimo de DES necessária para fazer o primeiro avanço na carreira como arqueiro.";
        ans = 25;
    } else if (q == 5) {
        desc = "Esta é a tarefa. O número de cupons que você deve coletar é o mesmo número do nível mínimo de DES necessária para fazer o primeiro avanço na carreira como gatuno.";
        ans = 25;
    } else if (q == 6) {
        ...
        desc = "Esta é a tarefa. O número de cupons que você deve coletar é o mesmo número do nível necessário para fazer o primeiro avanço na carreira como arqueiro.";
        ans = 10;
    } else if (q == 8) {
        desc = "Esta é a tarefa. O número de cupons que você deve coletar é o mesmo número do nível necessário para fazer o primeiro avanço na carreira como gatuno.";
        ans = 10;
    }
